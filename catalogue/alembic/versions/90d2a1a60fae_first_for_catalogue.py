...
Revision ID: 90d2a1a60fae
Revises: 
Create Date: 2022-05-02 09:55:56.466845
...
def upgrade():
    ...
    sa.Column('snapshots', sa.ARRAY(sa.String()), nullable=True),
    sa.Column('difficulty', sa.String(), nullable=True),
    sa.Column('targets', sa.ARRAY(sa.String()), nullable=True),
    sa.Column('types', sa.ARRAY(sa.String()), nullable=True),
    sa.Column('administrative_scopes', sa.ARRAY(sa.String()), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['softwareinterlinker_id'], ['softwareinterlinker.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['phasemetadata_b_id'], ['phasemetadata.id'], ),
    ...
    sa.ForeignKeyConstraint(['objectivemetadata_b_id'], ['objectivemetadata.id'], ),
    ...
    sa.ForeignKeyConstraint(['taskmetadata_b_id'], ['taskmetadata.id'], ),
